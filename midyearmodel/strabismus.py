...
class RealTimeStrabismusDetectionApp:
    ...
    def capture_frame(self):
        ...
        try:
            ...
            base_dir = r"D:\FYP AZAM\Cap"  # Use a raw string to handle backslashes
...
def video_feed():
    app.detector_app = RealTimeStrabismusDetectionApp()
    return Response(app.detector_app.generate_frames(), mimetype='multipart/x-mixed-replace; boundary=frame')
@strabismus.route('/')
def index2():
